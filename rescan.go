...
func extractBlockMatches(chain ChainSource, ro *rescanOptions,
	curStamp *waddrmgr.BlockStamp) ([]*monautil.Tx, error) {
...
func (ro *rescanOptions) spendsWatchedInput(tx *monautil.Tx) bool {
...
func (ro *rescanOptions) paysWatchedAddr(tx *monautil.Tx) (bool, error) {
